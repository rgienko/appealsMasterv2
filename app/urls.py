...
urlpatterns = [
    ...
    path(r'prov-name-master/new/', views.new_provider_name_view.as_view(), name='new_provider_name_master_url'),
    path(r'prov-name-master/<provider_number>/edit/', views.provider_name_update_view.as_view(), name='provider_name_update_url'),
